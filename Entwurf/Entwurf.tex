...
\subsection{CommandLineProcessor}
...
\begin{itemize}[label={}]
	...
	\item\textit{\textbf{Methoden}}
		\begin{itemize}[label={\textbullet}]
			\item\textit{public void wait(int s)} Behandelt das angekommene Event.
			\item\textit{public void wait(const std::function<void()>\& func)} Behandelt das angekommene Event.
