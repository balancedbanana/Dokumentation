...
\item[FA5] Falls der Benutzer keine Parameter übergibt werden Standartwerte benutzt.
\item[FA6] Benutzer kann den Status einer Aufgabe einsehen.
\item[FA61] Benutzer kann die verstrichene Zeit einer Aufgabe einsehen. %evtl optional
\item[FA7] Benutzer bekommt Benachrichtigung über erledigte Aufgabe.
\item[FA8] Server erstellt regelmäßige Sicherungen von laufenden Aufgaben.
\item[FA9] Benutzer kann die Ausgabe seiner Aufgabe anfordern.
\end{itemize}
