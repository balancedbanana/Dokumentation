...
Betriebssystem: Linux oder Linux basiertes System\newline
Mindestanforderungen: 1 CPU Kern sowie 1 GB Arbeitsspeicher
\item \textbf{Scheduler (Server) Umgebung}\newline
Betriebssystem: CentOS 7 oder Ubuntu 18.04\newline
Mindestanforderungen: 1 CPU Kern sowie 4 GB Arbeitsspeicher
\item \textbf{Arbeiter (Worker) Umgebung}\newline
Betriebssystem: CentOS 7 oder Ubuntu 18.04\newline
Mindestanforderungen: 1 CPU Kern sowie 8 GB Arbeitsspeicher\newline
Empfohlen: 24 CPU Kerne sowie 64 GB Arbeitsspeicher
\subitem 
\end{itemize}
\newpage
...
Die \gls{Prioritaet} wird auf der Kommandozeile mit "--priority" oder "-p" angegeben.\newline
