...
\item[FA60] \textbf{Sichere Kommunikation}
\subitem \textbf{Erklärung} Um Nutzerdaten und Passwörter zu schützen ist eine gute Verschlüsslung unerlässlich
\subitem \textbf{Wichtigkeit} Sehr Hoch, damit der Datenschutz gewährleistet werden kann.
\subitem \textbf{Vorraussetzungen} Der Server muss im Netzwerk erreichbar sein.
\subitem \textbf{Nachbedingung} Die Netwerkverbindung ist Aktiv und der Server ist für weitere Kommunikation bereit.
\subsubitem \textbf{Erfolg} Bearbeiten der Anfrage fortsetzen
\subsubitem \textbf{Misserfolg} Fehlermeldung Ausgeben und Verbindung zum Server trennen.
\subitem \textbf{Details} Benutzer müssen sich über ein Anmeldesystem anmelden können, damit die idendität des Aufrufers sichergestellt werden kann.
\item[FA70] \textbf{Sicherungen}
\subitem \textbf{Erklärung} Damit bei einen Serverausfall gestartete Aufgaben nicht komplett von vorne beginnen müssen. Ermöglicht den Transfer einer Aufgabe von einen Arbeiter zum anderen.
\subitem \textbf{Wichtigkeit} Hoch
\subitem \textbf{Vorraussetzungen} Der Server muss im Netzwerk erreichbar sein.
\subsubitem \textbf{Erfolg} Der Benutzer bekommt eine ID der Sicherung
\subsubitem \textbf{Misserfolg} Fehlermeldung Ausgeben und Verbindung zum Server trennen.
