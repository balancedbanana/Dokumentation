...
\item[PD00] \textbf{<Titel>}
\subitem \textbf{Erklärung} <In ca. 3 Zeilen eine grobe Beschreibung geben>
\subitem \textbf{Wichtigkeit} <Soll dieses Datum unbedingt gespeichert werden (core) oder ist es optional?>
\subitem \textbf{Details} <Ausführliche Beschreibung dieses Produktdatums>
\end{minipage}
\pagebreak
%Ende der Vorlage
...
\item[PD00] \textbf{Benutzer}
\subitem \textbf{Erklärung} Wird zur Zuordnung von Benutzern und Aufgaben verwendet, damit 
\subitem \textbf{Wichtigkeit} <Soll dieses Datum unbedingt gespeichert werden (core) oder ist es optional?>
\subitem \textbf{Details} <Ausführliche Beschreibung dieses Produktdatums>
\end{itemize}
\item[PD00] \textbf{Befehl}
\subitem \textbf{Erklärung} <In ca. 3 Zeilen eine grobe Beschreibung geben>
\subitem \textbf{Wichtigkeit} <Soll dieses Datum unbedingt gespeichert werden (core) oder ist es optional?>
\subitem \textbf{Details} <Ausführliche Beschreibung dieses Produktdatums>
\end{itemize}
